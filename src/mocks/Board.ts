...
export const RANDOM_10X10_BOARD: TBoard = [
	...
	['empty', 'empty', 'empty', 'snake', 'snake', 'snake', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'food', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
	['empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty', 'snake', 'empty', 'empty'],
];
